...
*|*► *${prefix}aniver* DD/MM - Registra sua data de aniversário
*|*► *${prefix}listaniver* - Exibe a lista de aniversariantes do grupo
*|*
*|*━✦༻ _*Feito por: Mellody Nunes*_ ༺✦`;
};
...
*|*► *${prefix}dono* - Dono do grupo
*|*► *${prefix}aniver* DD/MM - Registra sua data de aniversário
*|*► *${prefix}listaniver* - Exibe a lista de aniversariantes
*|*
*|*━━ ✦ 👤 *MEMBROS* ✦
...
*|*► *${prefix}mascote* - Onipotente e onipresente WhatsApp Jr
*|*► *${prefix}frase* - Frase dúvidosa do WhatsApp Jr
*|*► *${prefix}sapatometro* - Mede o nível de sapatonice com base em pura ciência(e um pouco de caos emocional)
*|*► *${prefix}detector* - Detector de mentira
*|*► *${prefix}casal* - Escolhe um casal
*|*► *${prefix}marmita* - Sorteia uma marmita (terceira envolvida) para um casal mencionado
